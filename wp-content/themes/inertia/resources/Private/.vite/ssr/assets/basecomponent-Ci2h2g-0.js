...
import { Ct as c$1, Mt as s, Ot as m, St as a, at as c, gt as F, ht as C, m as S, pt as z, u as N, wt as g } from "./dist-D3DM3lbw.js";
import { t as BaseStyle } from "./style-BBiR4gGd.js";
import { t as Base } from "./base-C3ggFGS_.js";
...
var script = {
	...
	methods: {
		...
		_mergeProps: function _mergeProps(fn) {
			...
			return c$1(fn) ? fn.apply(void 0, args) : vue_exports.mergeProps.apply(void 0, args);
		},
		...
		_getPTSelf: function _getPTSelf() {
			...
			return (0, vue_exports.mergeProps)(this._usePT.apply(this, [this._getPT(obj, this.$name)].concat(args)), this._usePT.apply(this, [this.$_attrsPT].concat(args)));
		},
		...
		ptmi: function ptmi() {
			...
			var key = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "";
			var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
			var attrs = (0, vue_exports.mergeProps)(this.$_attrsWithoutPT, this.ptm(key, params));
