...
var _sfc_main = {
	...
	setup(__props, { emit: __emit }) {
		...
		const Checkbox = (0, vue_exports.defineAsyncComponent)(() => import("./checkbox-DNl9xF0Q.js"));
		...
		*/
		...
		return (_ctx, _push, _parent, _attrs) => {
			if (shouldShow.value) {
				_push(`<div${(0, server_renderer_exports.ssrRenderAttrs)((0, vue_exports.mergeProps)({ class: ["mt-8 flex w-full flex-col gap-2", __props.field?.cssClass] }, _attrs))}><label class="text-mob text-dark-gold leading-[1.4] tracking-[0.4px]">${__props.field.label ?? ""}</label><div class="flex flex-col gap-2"><!--[-->`);
