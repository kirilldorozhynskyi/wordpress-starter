...
import { t as script$2 } from "./baseinput-ta2-o0PW.js";
//#endregion
...
var script = {
	...
	computed: {
		attrs: function attrs() {
			return (0, vue_exports.mergeProps)(this.ptmi("root", { context: {
				filled: this.$filled,
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
	return (0, vue_exports.openBlock)(), (0, vue_exports.createElementBlock)("textarea", (0, vue_exports.mergeProps)({
		"class": _ctx.cx("root"),
		value: _ctx.d_value,
		name: _ctx.name,
