...
function createTextNode(key) {
	return (0, vue_exports.createVNode)(vue_exports.Text, null, key, 0);
}
function getCurrentInstance() {
	const key = "currentInstance";
	if (key in vue_exports) return vue_exports[key];
	else return vue_exports.getCurrentInstance();
}
...
function createComposer(options = {}) {
	...
	const _ref = inBrowser ? vue_exports.ref : vue_exports.shallowRef;
	...
	const locale = (0, vue_exports.computed)({
		get: () => _locale.value,
		set: (val) => {
			_context.locale = val;
			_locale.value = val;
	...
	const fallbackLocale = (0, vue_exports.computed)({
	...
	const messages = (0, vue_exports.computed)(() => _messages.value);
	const datetimeFormats = /* @__PURE__ */ (0, vue_exports.computed)(() => _datetimeFormats.value);
	const numberFormats = /* @__PURE__ */ (0, vue_exports.computed)(() => _numberFormats.value);
 ...
 /* istanbul ignore next */
	...
	composerID++;
	if (__root && inBrowser) {
		(0, vue_exports.watch)(__root.locale, (val) => {
			if (_inheritLocale) {
				_locale.value = val;
				_context.locale = val;
				updateFallbackLocale(_context, _locale.value, _fallbackLocale.value);
		...
		(0, vue_exports.watch)(__root.fallbackLocale, (val) => {
			if (_inheritLocale) {
				_fallbackLocale.value = val;
				_context.fallbackLocale = val;
				updateFallbackLocale(_context, _locale.value, _fallbackLocale.value);
...
function defineMixin(vuei18n, composer, i18n) {
	return {
		...
		mounted() {
			/* istanbul ignore if */
			if ((process.env.NODE_ENV !== "production" || false) && this.$i18n) {
				const instance = getCurrentInstance();
				if (!instance) return;
				const _vueI18n = this.$i18n;
		...
		unmounted() {
			...
			const _vueI18n = this.$i18n;
			/* istanbul ignore if */
			if ((process.env.NODE_ENV !== "production" || false) && instance.__VUE_I18N__) {
				if (this.__v_emitter) {
...
function getInterpolateArg({ slots }, keys) {
	if (keys.length === 1 && keys[0] === "default") return (slots.default ? slots.default() : []).reduce((slot, current) => {
		return [...slot, ...current.type === vue_exports.Fragment ? current.children : [current]];
	}, []);
...
* @VueI18nComponent
*/
var Translation = /* @__PURE__ */ (0, vue_exports.defineComponent)({
	name: "i18n-t",
	props: assign({
		keypath: {
			type: String,
	...
	setup(props, context) {
		...
		return () => {
			...
			return (0, vue_exports.h)(isString(props.tag) || isObject(props.tag) ? props.tag : getFragmentableTag(), assignedAttrs, children);
		};
	}
});
...
* @VueI18nComponent
*/
var NumberFormat = /* @__PURE__ */ (0, vue_exports.defineComponent)({
	name: "i18n-n",
	props: assign({
		value: {
			type: Number,
...
function vTDirective(i18n) {
	...
	const register = (el, binding) => {
		...
		if (inBrowser) el.__i18nWatcher = (0, vue_exports.watch)(composer.locale, () => {
...
function createI18n(options = {}) {
	...
	if (process.env.NODE_ENV !== "production" && __legacyMode) warnOnce(getWarnMessage(I18nWarnCodes.DEPRECATE_LEGACY_MODE));
...
function getI18nInstance(instance) {
	const i18n = (0, vue_exports.inject)(!instance.isCE ? instance.appContext.app.__VUE_I18N_SYMBOL__ : I18nInjectionKey);
	/* istanbul ignore if */
...
function injectGlobalFields(app, composer) {
	...
	globalExportProps.forEach((prop) => {
		...
		const wrap = (0, vue_exports.isRef)(desc.value) ? {
			get() {
...
* @VueI18nComponent
*/
var DatetimeFormat = /* @__PURE__ */ (0, vue_exports.defineComponent)({
	name: "i18n-d",
	props: assign({
		value: {
			type: [Number, Date],
