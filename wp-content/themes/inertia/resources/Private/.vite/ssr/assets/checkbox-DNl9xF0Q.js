...
import { Et as k, jt as q } from "./dist-D3DM3lbw.js";
import { t as f } from "./classnames-sTakKMOI.js";
import { t as BaseStyle } from "./style-BBiR4gGd.js";
import { t as script$3 } from "./baseicon-TXNiTVsE.js";
import { t as script$4 } from "./check-DLKLYx6t.js";
import { t as script$5 } from "./baseinput-ta2-o0PW.js";
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
	...
	var _component_MinusIcon = (0, vue_exports.resolveComponent)("MinusIcon");
	return (0, vue_exports.openBlock)(), (0, vue_exports.createElementBlock)("div", (0, vue_exports.mergeProps)({ "class": _ctx.cx("root") }, $options.getPTOptions("root"), {
	...
	}, $options.getPTOptions("input")), null, 16, _hoisted_2), (0, vue_exports.createElementVNode)("div", (0, vue_exports.mergeProps)({ "class": _ctx.cx("box") }, $options.getPTOptions("box"), { "data-p": $options.dataP }), [(0, vue_exports.renderSlot)(_ctx.$slots, "icon", {
		checked: $options.checked,
		indeterminate: $data.d_indeterminate,
		"class": (0, vue_exports.normalizeClass)(_ctx.cx("icon")),
		dataP: $options.dataP
	}, function() {
		return [$options.checked ? ((0, vue_exports.openBlock)(), (0, vue_exports.createBlock)(_component_CheckIcon, (0, vue_exports.mergeProps)({
			key: 0,
			"class": _ctx.cx("icon")
		}, $options.getPTOptions("icon"), { "data-p": $options.dataP }), null, 16, ["class", "data-p"])) : $data.d_indeterminate ? ((0, vue_exports.openBlock)(), (0, vue_exports.createBlock)(_component_MinusIcon, (0, vue_exports.mergeProps)({
			key: 1,
			"class": _ctx.cx("icon")
		}, $options.getPTOptions("icon"), { "data-p": $options.dataP }), null, 16, ["class", "data-p"])) : (0, vue_exports.createCommentVNode)("", true)];
