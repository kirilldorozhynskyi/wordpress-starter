...
import { _t as H, m as S, u as N } from "./dist-D3DM3lbw.js";
import { t as FilterMatchMode } from "./api-B3JjHrmm.js";
import { t as BaseStyle } from "./style-BBiR4gGd.js";
import { t as PrimeVueService } from "./service-D5CGdYMe.js";
...
function usePrimeVue() {
	var PrimeVue = (0, vue_exports.inject)(PrimeVueSymbol);
	if (!PrimeVue) throw new Error("PrimeVue is not installed!");
	return PrimeVue;
}
function setup(app, options) {
	var PrimeVue = { config: (0, vue_exports.reactive)(options) };
...
function setupConfig(app, PrimeVue) {
	var isThemeChanged = (0, vue_exports.ref)(false);
	...
	/*** Watchers ***/
	var stopConfigWatcher = (0, vue_exports.watch)(PrimeVue.config, function(newValue, oldValue) {
	...
	var stopRippleWatcher = (0, vue_exports.watch)(function() {
	...
	var stopThemeWatcher = (0, vue_exports.watch)(function() {
	...
	var stopUnstyledWatcher = (0, vue_exports.watch)(function() {
...
//#endregion
export { setupConfig as a, setup as i, clearConfig as n, usePrimeVue as o, defaultOptions as r, PrimeVue as t };
